...
```
## Dygraph instead of an animation plot?
## Using dyHighlight() and shiny() so that users can toggle plots on and off if they wanted to see the trend of different states or compare them with 1-2 states
